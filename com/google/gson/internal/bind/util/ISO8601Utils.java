...
/*  34 */   private static final TimeZone TIMEZONE_UTC = TimeZone.getTimeZone("UTC");
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  49 */     return format(date, false, TIMEZONE_UTC);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */     return format(date, millis, TIMEZONE_UTC);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*  72 */     Calendar calendar = new GregorianCalendar(tz, Locale.US);
/*  73 */     calendar.setTime(date);
/*     */ 
/*     */     
/*  76 */     int capacity = "yyyy-MM-ddThh:mm:ss".length();
/*  77 */     capacity += millis ? ".sss".length() : 0;
/*  78 */     capacity += (tz.getRawOffset() == 0) ? "Z".length() : "+hh:mm".length();
/*  79 */     StringBuilder formatted = new StringBuilder(capacity);
/*     */     
/*  81 */     padInt(formatted, calendar.get(1), "yyyy".length());
/*  82 */     formatted.append('-');
/*  83 */     padInt(formatted, calendar.get(2) + 1, "MM".length());
/*  84 */     formatted.append('-');
/*  85 */     padInt(formatted, calendar.get(5), "dd".length());
/*  86 */     formatted.append('T');
/*  87 */     padInt(formatted, calendar.get(11), "hh".length());
/*  88 */     formatted.append(':');
/*  89 */     padInt(formatted, calendar.get(12), "mm".length());
/*  90 */     formatted.append(':');
/*  91 */     padInt(formatted, calendar.get(13), "ss".length());
/*  92 */     if (millis) {
/*  93 */       formatted.append('.');
/*  94 */       padInt(formatted, calendar.get(14), "sss".length());
/*     */     } 
/*     */     
/*  97 */     int offset = tz.getOffset(calendar.getTimeInMillis());
/*  98 */     if (offset != 0) {
/*  99 */       int hours = Math.abs(offset / 60000 / 60);
/* 100 */       int minutes = Math.abs(offset / 60000 % 60);
/* 101 */       formatted.append((offset < 0) ? 45 : 43);
/* 102 */       padInt(formatted, hours, "hh".length());
/* 103 */       formatted.append(':');
/* 104 */       padInt(formatted, minutes, "mm".length());
/*     */     } else {
/* 106 */       formatted.append('Z');
/*     */     } 
/*     */     
/* 109 */     return formatted.toString();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 293 */     return (offset < value.length() && value.charAt(offset) == expected);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 306 */     if (beginIndex < 0 || endIndex > value.length() || beginIndex > endIndex) {
/* 307 */       throw new NumberFormatException(value);
/*     */     }
/*     */     
/* 310 */     int i = beginIndex;
/* 311 */     int result = 0;
/*     */     
/* 313 */     if (i < endIndex) {
/* 314 */       int digit = Character.digit(value.charAt(i++), 10);
/* 315 */       if (digit < 0) {
/* 316 */         throw new NumberFormatException("Invalid number: " + value.substring(beginIndex, endIndex));
/*     */       }
/* 318 */       result = -digit;
/*     */     } 
/* 320 */     while (i < endIndex) {
/* 321 */       int digit = Character.digit(value.charAt(i++), 10);
/* 322 */       if (digit < 0) {
/* 323 */         throw new NumberFormatException("Invalid number: " + value.substring(beginIndex, endIndex));
/*     */       }
/* 325 */       result *= 10;
/* 326 */       result -= digit;
/*     */     } 
...
/* 339 */     String strValue = Integer.toString(value);
/* 340 */     for (int i = length - strValue.length(); i > 0; i--) {
/* 341 */       buffer.append('0');
/*     */     }
/* 343 */     buffer.append(strValue);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 350 */     for (int i = offset; i < string.length(); i++) {
/* 351 */       char c = string.charAt(i);
/* 352 */       if (c < '0' || c > '9') return i; 
/*     */     } 
...
/* Location:              C:\Users\.essenza\Downloads\38833FF26BA1D.UnigramPreview_g9c9v27vpyspw!App\RealityPhone-1.0-SNAPSHOT.jar!\com\google\gson\internal\bin\\util\ISO8601Utils.class

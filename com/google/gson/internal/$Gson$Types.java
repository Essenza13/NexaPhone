...
/* 164 */     throw new IllegalArgumentException("Expected a Class, ParameterizedType, or GenericArrayType, but <" + type + "> is of type " + className);
/*     */   }
/*     */ 
/*     */ 
/*     */   
/*     */   private static boolean equal(Object a, Object b) {
/* 170 */     return (a == b || (a != null && a.equals(b)));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 179 */       return true;
/*     */     }
/* 181 */     if (a instanceof Class)
/*     */     {
/* 183 */       return a.equals(b);
/*     */     }
/* 185 */     if (a instanceof ParameterizedType) {
...
/* 193 */       return (equal(pa.getOwnerType(), pb.getOwnerType()) && pa
/* 194 */         .getRawType().equals(pb.getRawType()) && 
/* 195 */         Arrays.equals((Object[])pa.getActualTypeArguments(), (Object[])pb.getActualTypeArguments()));
/*     */     } 
/* 197 */     if (a instanceof GenericArrayType) {
...
/*     */     } 
/* 206 */     if (a instanceof WildcardType) {
...
/* 213 */       return (Arrays.equals((Object[])wa.getUpperBounds(), (Object[])wb.getUpperBounds()) && 
/* 214 */         Arrays.equals((Object[])wa.getLowerBounds(), (Object[])wb.getLowerBounds()));
/*     */     } 
/* 216 */     if (a instanceof TypeVariable) {
/* 217 */       if (!(b instanceof TypeVariable)) {
/* 218 */         return false;
/*     */       }
/* 220 */       TypeVariable<?> va = (TypeVariable)a;
/* 221 */       TypeVariable<?> vb = (TypeVariable)b;
/* 222 */       return (va.getGenericDeclaration() == vb.getGenericDeclaration() && va
/* 223 */         .getName().equals(vb.getName()));
/*     */     } 
/*     */ 
/*     */     
/* 227 */     return false;
...
/* 251 */         if (supertype.isAssignableFrom(interfaces[i])) {
...
/* 263 */         if (supertype.isAssignableFrom(rawSupertype)) {
...
/*     */     } 
/* 289 */     $Gson$Preconditions.checkArgument(supertype.isAssignableFrom(contextRawType));
...
/* 328 */       return new Type[] { String.class, String.class };
/*     */     }
/*     */     
...
/* 342 */     return resolve(context, contextRawType, toResolve, new HashMap<>());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 489 */       Objects.requireNonNull(rawType);
/*     */       
/* 491 */       if (rawType instanceof Class) {
/* 492 */         Class<?> rawTypeAsClass = (Class)rawType;
/*     */         
/* 494 */         boolean isStaticOrTopLevelClass = (Modifier.isStatic(rawTypeAsClass.getModifiers()) || rawTypeAsClass.getEnclosingClass() == null);
/* 495 */         $Gson$Preconditions.checkArgument((ownerType != null || isStaticOrTopLevelClass));
/*     */       } 
/*     */       
/* 498 */       this.ownerType = (ownerType == null) ? null : $Gson$Types.canonicalize(ownerType);
/* 499 */       this.rawType = $Gson$Types.canonicalize(rawType);
/* 500 */       this.typeArguments = (Type[])typeArguments.clone();
/* 501 */       for (int t = 0, length = this.typeArguments.length; t < length; t++) {
/* 502 */         Objects.requireNonNull(this.typeArguments[t]);
/* 503 */         $Gson$Types.checkNotPrimitive(this.typeArguments[t]);
/* 504 */         this.typeArguments[t] = $Gson$Types.canonicalize(this.typeArguments[t]);
/*     */       } 
/*     */     }
/*     */     private final Type[] typeArguments; private static final long serialVersionUID = 0L;
/*     */     public Type[] getActualTypeArguments() {
/* 509 */       return (Type[])this.typeArguments.clone();
/*     */     }
/*     */     
/*     */     public Type getRawType() {
/* 513 */       return this.rawType;
/*     */     }
/*     */     
/*     */     public Type getOwnerType() {
/* 517 */       return this.ownerType;
/*     */     }
/*     */     
/*     */     public boolean equals(Object other) {
/* 521 */       return (other instanceof ParameterizedType && 
/* 522 */         $Gson$Types.equals(this, (ParameterizedType)other));
/*     */     }
/*     */     
/*     */     private static int hashCodeOrZero(Object o) {
/* 526 */       return (o != null) ? o.hashCode() : 0;
/*     */     }
/*     */     
/*     */     public int hashCode() {
/* 530 */       return Arrays.hashCode((Object[])this.typeArguments) ^ this.rawType
/* 531 */         .hashCode() ^ 
/* 532 */         hashCodeOrZero(this.ownerType);
/*     */     }
/*     */     
/*     */     public String toString() {
/* 536 */       int length = this.typeArguments.length;
/* 537 */       if (length == 0) {
/* 538 */         return $Gson$Types.typeToString(this.rawType);
/*     */       }
/*     */       
/* 541 */       StringBuilder stringBuilder = new StringBuilder(30 * (length + 1));
/* 542 */       stringBuilder.append($Gson$Types.typeToString(this.rawType)).append("<").append($Gson$Types.typeToString(this.typeArguments[0]));
/* 543 */       for (int i = 1; i < length; i++) {
/* 544 */         stringBuilder.append(", ").append($Gson$Types.typeToString(this.typeArguments[i]));
/*     */       }
/* 546 */       return stringBuilder.append(">").toString();
/*     */     }
/*     */   }
/*     */   
...
/* 556 */       Objects.requireNonNull(componentType);
/* 557 */       this.componentType = $Gson$Types.canonicalize(componentType);
/*     */     }
/*     */     
/*     */     public Type getGenericComponentType() {
/* 561 */       return this.componentType;
/*     */     }
/*     */     
/*     */     public boolean equals(Object o) {
/* 565 */       return (o instanceof GenericArrayType && 
/* 566 */         $Gson$Types.equals(this, (GenericArrayType)o));
/*     */     }
/*     */     
/*     */     public int hashCode() {
/* 570 */       return this.componentType.hashCode();
/*     */     }
/*     */     
/*     */     public String toString() {
/* 574 */       return $Gson$Types.typeToString(this.componentType) + "[]";
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 591 */       $Gson$Preconditions.checkArgument((lowerBounds.length <= 1));
/* 592 */       $Gson$Preconditions.checkArgument((upperBounds.length == 1));
/*     */       
/* 594 */       if (lowerBounds.length == 1) {
/* 595 */         Objects.requireNonNull(lowerBounds[0]);
/* 596 */         $Gson$Types.checkNotPrimitive(lowerBounds[0]);
/* 597 */         $Gson$Preconditions.checkArgument((upperBounds[0] == Object.class));
/* 598 */         this.lowerBound = $Gson$Types.canonicalize(lowerBounds[0]);
/* 599 */         this.upperBound = Object.class;
/*     */       } else {
/*     */         
/* 602 */         Objects.requireNonNull(upperBounds[0]);
/* 603 */         $Gson$Types.checkNotPrimitive(upperBounds[0]);
/* 604 */         this.lowerBound = null;
/* 605 */         this.upperBound = $Gson$Types.canonicalize(upperBounds[0]);
/*     */       } 
/*     */     }
/*     */     
/*     */     public Type[] getUpperBounds() {
/* 610 */       return new Type[] { this.upperBound };
/*     */     }
/*     */     
/*     */     public Type[] getLowerBounds() {
/* 614 */       (new Type[1])[0] = this.lowerBound; return (this.lowerBound != null) ? new Type[1] : $Gson$Types.EMPTY_TYPE_ARRAY;
/*     */     }
/*     */     
/*     */     public boolean equals(Object other) {
/* 618 */       return (other instanceof WildcardType && 
/* 619 */         $Gson$Types.equals(this, (WildcardType)other));
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
/* 624 */       return ((this.lowerBound != null) ? (31 + this.lowerBound.hashCode()) : 1) ^ 31 + this.upperBound
/* 625 */         .hashCode();
/*     */     }
/*     */     
/*     */     public String toString() {
/* 629 */       if (this.lowerBound != null)
/* 630 */         return "? super " + $Gson$Types.typeToString(this.lowerBound); 
/* 631 */       if (this.upperBound == Object.class) {
/* 632 */         return "?";
/*     */       }
/* 634 */       return "? extends " + $Gson$Types.typeToString(this.upperBound);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\.essenza\Downloads\38833FF26BA1D.UnigramPreview_g9c9v27vpyspw!App\RealityPhone-1.0-SNAPSHOT.jar!\com\google\gson\internal\$Gson$Types.class

...
/*  60 */     Preconditions.checkNotNull(itemStack, "The ItemStack for the GUI Item cannot be null!");
/*     */     
/*  62 */     this.action = action;
/*     */ 
/*     */     
/*  65 */     this.itemStack = ItemNbt.setString(itemStack.clone(), "mf-gui", this.uuid.toString());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 102 */     Preconditions.checkNotNull(itemStack, "The ItemStack for the GUI Item cannot be null!");
/* 103 */     this.itemStack = ItemNbt.setString(itemStack.clone(), "mf-gui", this.uuid.toString());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\.essenza\Downloads\38833FF26BA1D.UnigramPreview_g9c9v27vpyspw!App\RealityPhone-1.0-SNAPSHOT.jar!\dev\triumphteam\gui\guis\GuiItem.class

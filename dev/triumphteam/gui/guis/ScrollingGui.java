...
/* 270 */       if (getGuiItem(slot) != null || getInventory().getItem(slot) != null) { slot++; continue; }
...
/* 286 */         if (getGuiItem(slot) != null || getInventory().getItem(slot) != null) { row++; continue; }
/* 287 */          getMutableCurrentPageItems().put(Integer.valueOf(slot), guiItem);
/* 288 */         getInventory().setItem(slot, guiItem.getItemStack());
/*     */         return;
/*     */       } 
/*     */     } 
/*     */   }
...
/* 301 */     int page = givenPage - 1;
/* 302 */     int pageItemsSize = getPageItems().size();
/*     */     
/* 304 */     List<GuiItem> guiPage = new ArrayList<>();
/*     */     
/* 306 */     int max = page * this.scrollSize + getPageSize();
/* 307 */     if (max > pageItemsSize) max = pageItemsSize;
/*     */     
/* 309 */     for (int i = page * this.scrollSize; i < max; i++) {
/* 310 */       guiPage.add(getPageItems().get(i));
/*     */     }
/*     */     
/* 313 */     return guiPage;
/*     */   }
...
/* Location:              C:\Users\.essenza\Downloads\38833FF26BA1D.UnigramPreview_g9c9v27vpyspw!App\RealityPhone-1.0-SNAPSHOT.jar!\dev\triumphteam\gui\guis\ScrollingGui.class
